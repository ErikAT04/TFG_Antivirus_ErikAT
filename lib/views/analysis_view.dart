...
class AnalysisView extends StatelessWidget {
  ...
  */
  ...
  void preAnalyse(String? customDir, BuildContext context) async {
    ...
    if (Platform.isAndroid) {
      ...
      if (await Permission.manageExternalStorage.status.isGranted) {
        ...
        startAnalysis(customDir, context);
  ...
  void startAnalysis(String? customDir, BuildContext context) async {
    ...
    compute(scanDirInThread, args).onError((e, _) async {
      Logger().e("Error: $e");
    });
  ...
  void scanDirInThread(List<dynamic> args) async {
  ...
  Future<void> scanDir(Directory dir, List<String> signatures,
  ...
  Future<void> putInQuarantine(String fpath, String sig) async {
  ...
  Future<void> setAllOnQuarantine(List<Map<String, String>> message) async {
