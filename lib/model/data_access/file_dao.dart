  ...
  Future<QuarantinedFile?> get(int value) async {
    try {
      ...
      return QuarantinedFile(
          ...
          newName: line["newName"].toString(),
          newRoute: line["newRoute"].toString(),
          malwareType: line["malwareType"].toString(),
          quarantineDate: DateTime.parse(
              line["quarantineDate"].toString().substring(0, 10)));
    } catch (e) {
      Logger().e(e);
      return null;
    }
