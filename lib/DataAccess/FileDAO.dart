...
class FileDAO implements DAOInterface<SysFile, int>{
  ///Función de borrado: Recibe un item y lo borra por su ID
  @override
  ...
  ///Función de Obtención (Sin uso actualmente): Recibe un id por parámetro y devuelve la información de un fichero
  @override
  ...
  ///Función de Inserción: Recibe un item y guarda su información en la base de datos
  @override
  ...
  ///Función de Listado: Envia al usuario el listado de todos los archivos en la BD 
  @override
...
*/
  ///Función de Modificación (Sin uso actualmente): Recibe un objeto entero por parámetro y cambia todos sus valores de la BD en función del ID 
  @override
